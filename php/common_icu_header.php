    ...
    <div class="container">
      ...
      <div class="nav-collapse collapse">
        ...
        <ul id="social_account" class="nav">
            ...
            <li class="social-icon"><a href="http://youtube.com/icuinparis" title="ICU on YouTube" target="_blank"><img src="/wp/wp-content/themes/icuinparis/img/icons/icon-youtube.png" alt="ICU on YouTube" /></a></li>         
        </ul>
      </div><!--/.nav-collapse -->
    </div>
  </div>
