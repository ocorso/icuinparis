<?php
/*
Plugin Name: WooCommerce Widget Product Slideshow PRO
...
License: GPLv2 or later
	...
	WooCommerce Widget Product Slideshow PRO plugin.
...
define( 'WC_GALLERY_WIDGET_WP_TESTED', '3.5.1' );
if(!defined("WC_GALLERY_WIDGET_MANAGER_URL"))
	define("WC_GALLERY_WIDGET_MANAGER_URL", "http://a3api.com/plugins");
 ...
 */
register_deactivation_hook(__FILE__,'woo_gallery_widget_uninstall');
?>